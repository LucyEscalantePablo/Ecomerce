...
import { MemoryStick as Memory, User, Mail, Lock, ShieldCheck, ArrowLeft } from 'lucide-react';
...
export default function RegisterView({ onNavigate, onRegister }: RegisterViewProps) {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="bg-slate-900/80 backdrop-blur-md border border-white/5 rounded-3xl p-8 md:p-10 shadow-2xl">
